...
insert  into `field`(`id`,`entityId`,`title`,`alias`,`columnTypeId`,`elementId`,`defaultValue`,`move`,`relation`,`satellite`,`dependency`,`storeRelationAbility`,`alternative`,`filter`,`satellitealias`,`mode`,`tooltip`) values (2241,307,'Количество ЮЛ','llcQty',3,18,'0',2242,0,0,'u','none','','','','readonly','');
insert  into `field`(`id`,`entityId`,`title`,`alias`,`columnTypeId`,`elementId`,`defaultValue`,`move`,`relation`,`satellite`,`dependency`,`storeRelationAbility`,`alternative`,`filter`,`satellitealias`,`mode`,`tooltip`) values (2242,307,'Обновлено','updated',6,12,'0000-00-00',2243,0,0,'u','none','','','','readonly','');
insert  into `field`(`id`,`entityId`,`title`,`alias`,`columnTypeId`,`elementId`,`defaultValue`,`move`,`relation`,`satellite`,`dependency`,`storeRelationAbility`,`alternative`,`filter`,`satellitealias`,`mode`,`tooltip`) values (2247,307,'Стандартизация адреса','dadata',4,6,'',2248,0,0,'u','none','','','','hidden','');
insert  into `field`(`id`,`entityId`,`title`,`alias`,`columnTypeId`,`elementId`,`defaultValue`,`move`,`relation`,`satellite`,`dependency`,`storeRelationAbility`,`alternative`,`filter`,`satellitealias`,`mode`,`tooltip`) values (2243,307,'Файл капчи','captchaImg',0,14,'',2245,0,0,'u','none','','','','regular','');
insert  into `field`(`id`,`entityId`,`title`,`alias`,`columnTypeId`,`elementId`,`defaultValue`,`move`,`relation`,`satellite`,`dependency`,`storeRelationAbility`,`alternative`,`filter`,`satellitealias`,`mode`,`tooltip`) values (2244,307,'Код капчи','captchaCode',3,18,'0',2247,0,0,'u','none','','','','readonly','');
insert  into `field`(`id`,`entityId`,`title`,`alias`,`columnTypeId`,`elementId`,`defaultValue`,`move`,`relation`,`satellite`,`dependency`,`storeRelationAbility`,`alternative`,`filter`,`satellitealias`,`mode`,`tooltip`) values (2245,307,'Капча','captcha',0,16,'',2244,0,0,'u','none','','','','regular','');
insert  into `field`(`id`,`entityId`,`title`,`alias`,`columnTypeId`,`elementId`,`defaultValue`,`move`,`relation`,`satellite`,`dependency`,`storeRelationAbility`,`alternative`,`filter`,`satellitealias`,`mode`,`tooltip`) values (2246,307,'Задача','captchaTask',1,1,'',2246,0,0,'u','none','','','','readonly','');
...
insert  into `grid`(`id`,`sectionId`,`fieldId`,`move`,`alterTitle`,`toggle`,`title`,`gridId`,`tooltip`,`access`,`profileIds`,`editor`) values (2353,387,2240,2352,'','y','Статус',2360,'','all','','0');
insert  into `grid`(`id`,`sectionId`,`fieldId`,`move`,`alterTitle`,`toggle`,`title`,`gridId`,`tooltip`,`access`,`profileIds`,`editor`) values (2354,387,2241,2353,'','y','Количество ЮЛ',2360,'','all','','0');
insert  into `grid`(`id`,`sectionId`,`fieldId`,`move`,`alterTitle`,`toggle`,`title`,`gridId`,`tooltip`,`access`,`profileIds`,`editor`) values (2355,387,2242,2354,'','y','Обновлено',2360,'','all','','0');
...
insert  into `section`(`id`,`sectionId`,`entityId`,`title`,`alias`,`toggle`,`move`,`rowsOnPage`,`extends`,`defaultSortField`,`defaultSortDirection`,`filter`,`disableAdd`,`type`,`parentSectionConnector`,`groupBy`,`rowsetSeparate`) values (387,29,307,'Адреса для проверки','addresses','y',387,25,'Indi_Controller_Admin',0,'ASC','',0,'p',0,0,'auto');
